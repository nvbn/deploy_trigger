...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('tasks_job', (
            ...
            ('input', self.gf('django.db.models.fields.TextField')(blank=True, null=True)),
            ('output', self.gf('django.db.models.fields.TextField')(blank=True, null=True)),
            ('started', self.gf('django.db.models.fields.DateTimeField')(blank=True, auto_now_add=True)),
            ('finished', self.gf('django.db.models.fields.DateTimeField')(blank=True, null=True)),
    ...
    models = {
        ...
        'tasks.job': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'input': ('django.db.models.fields.TextField', [], {'blank': 'True', 'null': 'True'}),
            'output': ('django.db.models.fields.TextField', [], {'blank': 'True', 'null': 'True'}),
            'started': ('django.db.models.fields.DateTimeField', [], {'blank': 'True', 'auto_now_add': 'True'}),
